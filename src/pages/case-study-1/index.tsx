    ...
    <main className="max-w-6xl mx-auto px-6 py-16">
      ...
      <section className="mb-24">
        ...
        <div className="flex flex-col gap-2 md:gap-4">
          <h2 className="text-h6 md:text-h5 font-bold md:font-bold">The Problem I Walked Into</h2>
      ...
      <section className="mb-24">
        <h2 className="text-h6 md:text-h5 font-bold md:font-bold mb-4">My One‐Month Mission</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end justify-between">
          <div className="flex flex-col gap-2">
            ...
            <div>
              <p className="text-bodysmall md:text-bodymedium font-medium md:font-medium">In that time I was tasked with:</p>
              <ul className="list-disc pl-6 mt-2 mb-2 text-bodysmall md:text-bodymedium font-medium md:font-medium">
              ...
              <p className="text-bodysmall md:text-bodymedium font-medium md:font-medium">It felt ambitious — especially as I was still at “intermediate”
      ...
      <section className="mb-24">
        <h2 className="text-h6 md:text-h5 font-bold md:font-bold mb-4">Building the Foundation</h2>
        <div className="flex flex-col gap-4">
          ...
          <div className="relative w-full h-[260px] md:h-[628px] mt-4">
            <Image
          ...
          <p className="text-bodysmall md:text-bodymedium font-medium md:font-medium mt-4">
      ...
      {/* Creating Components */}
      <section className="mb-24">
        <h2 className="text-h6 md:text-h5 font-bold md:font-bold mb-4">Creating Components</h2>
        <div className="flex flex-col gap-4">
          <p className="text-bodysmall md:text-bodymedium font-medium md:font-medium">
          ...
          <div className="relative w-full h-[260px] md:h-[628px]">
            <Image
          ...
          <p className="text-bodysmall md:text-bodymedium font-medium md:font-medium mt-6 mb-6">
            Each component had:
          </p>
          ...
          <p
            className="text-bodysmall md:text-bodymedium font-medium md:font-medium mt-6
        "
          >
      ...
      <section className="mb-24">
        <h2 className="text-h6 md:text-h5 font-bold md:font-bold">Storybook: The Living Source</h2>
        <div className="flex flex-col gap-4">
          <p className="text-bodysmall md:text-bodymedium font-medium md:font-medium">
          ...
          <div className="flex flex-col gap-3 text-bodysmall md:text-bodymedium font-medium md:font-medium mt-4">
            <p>
      ...
      <section className="mb-24">
        ...
        <ul className="list-disc pl-6 space-y-2 text-bodysmall md:text-bodymedium font-medium md:font-medium">
          <li>
      ...
      <section className="mb-24">
        <h2 className="text-h6 md:text-h5 font-bold md:font-bold mb-4">What I Learned & What’s Next</h2>
        <p className="text-bodysmall md:text-bodymedium font-medium md:font-medium">
      ...
      {/* Explore Other */}
      <section className="mb-16">
        <h2 className="text-center text-h6 md:text-h5 font-bold md:font-bold mb-6">
