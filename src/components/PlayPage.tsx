...
export default function PlayPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Main */}
      <main className="max-w-6xl mx-auto px-8 py-16">
        <div className="flex flex-col text-center gap-0 md:gap-1 mb-6">
          <h1 className="font-zuume text-[48px] md:text-[64px] leading-tight lg:leading-none text-center">
            Playground
          </h1>
          <p className="text-[14px] md:text-bodymedium font-medium md:font-medium text-center">
            A space where I experiment, break rules, and play with design ideas.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[18px]">
          {images.map(({ src, alt }) => (
            <div
              key={alt}
              className="relative overflow-hidden rounded-xl bg-gradient-to-b from-[#fafafa] to-white min-h-[160px] flex items-center justify-center cursor-default"
            >
              <Image
                src={src}
                alt={alt}
